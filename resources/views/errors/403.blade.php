  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">No tienes permisos para ingresar a esta sección :(</h2>
        <p class="mb-4 mx-2">Comunicate con el administrador del sistema para solicitar permisos.</p>
        <a href="{{ route('login') }}" class="btn btn-primary">Identificate</a>
        <div class="mt-3">
          <img
