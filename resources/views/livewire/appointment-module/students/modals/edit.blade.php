                ...
                <div class="row g-2">
                    ...
                    <div class="row g-2">                        
                        <div class="col-12 col-lg-6 mb-6">
                            ...
                            <select name="semesterId" class="form-select" wire:model.lazy="semesterId">
                                ...
                                @foreach($semesters as $semester)
                                    <option value="{{ $semester->id }}" {{$semester->id == $semesterId ? 'selected':''}}>{{ $semester->name }}</option>
                                @endforeach
                        ...
                        <div class="col-12 col-lg-6 mb-6">
                            ...
                            <select name="typeDocument" class="form-select" wire:model.lazy="typeDocumentId">
                                <option value="" selected>Seleccione una opción</option>
                                @foreach($typesDocuments as $typeDocument)
                                    <option value="{{ $typeDocument->id }}" {{$typeDocument->id == $typeDocumentId ? 'selected':''}}>{{ $typeDocument->name }}</option>
                                @endforeach
