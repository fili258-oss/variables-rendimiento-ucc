            ...
            <div class="modal-body">
                <div class="row g-2">
                    <div class="col-12 col-lg-6 mb-2">
                        ...
                        <input type="text" id="name" class="form-control" wire:model="name" placeholder="Nombre de usuario" />
                        @error('name')
                    ...
                    <div class="col-12 col-lg-6 mb-2">
                        ...
                        <input type="email" id="email" class="form-control" wire:model="email" placeholder="Ingrese el correo" />
                        @error('email')
                        <span class="text-warning">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row g-12 mt-4">
                    ...
                    <div class="col-xs-6">
                        <div class="thumbnail">
                            ...
                            @elseif (!empty($image))
                            <img src="{{ asset('storage/' . $image) }}" class="img-responsive img-thumbnail" alt="" style="width:204px;height:auto;">
                            @else
